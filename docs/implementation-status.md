...
Validation run on 2026-09-17: 90 Bun unit/integration tests, 193 Convex tests,
...
| LLM-1 | Packages are pinned; Pi and MCP v2 load/run under Bun 1.3.9. The configured `gemma-4-12B-it-8bit` endpoint at `http://127.0.0.1:8000/v1` passed the real streamed MCP round trip and synthetic-history compaction/continuation checks on 2026-09-17. These use isolated fixture data, not live business records. No performance claim is made. |
